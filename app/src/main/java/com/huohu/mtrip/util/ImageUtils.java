...
import com.huohu.mtrip.view.wighet.Displayer;
...
public class ImageUtils {
    ...
    File cacheDir = StorageUtils.getOwnCacheDirectory(MApplication.getInstance().getContext(), "zhj121/imagecache");
    ...
    public void initImageLoader() {
        ...
        ImageLoaderConfiguration config = new ImageLoaderConfiguration
                .Builder(MApplication.getInstance().getContext())
                ...
                .imageDownloader(new BaseImageDownloader(MApplication.getInstance().getContext(), 5 * 1000, 30 * 1000)) // connectTimeout (5 s), readTimeout (30 s)超时时间
